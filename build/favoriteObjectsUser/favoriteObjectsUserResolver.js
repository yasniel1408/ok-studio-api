...
exports.favoriteObjectsUserResolver =
  exports.createFavoriteObjectsUser =
  exports.findAllFavoriteObjectsUser =
    void 0;
...
const findAllFavoriteObjectsUser = (parent, args, context) => {
  return (
    (0, verifyIfItIsAdmin_1.default)({ context }) && context.orm.favoriteObjectsUser.findMany()
  );
};
exports.findAllFavoriteObjectsUser = findAllFavoriteObjectsUser;
const createFavoriteObjectsUser = (parent, args, context) =>
